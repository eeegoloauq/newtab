...
func TestIndexIsHTMLAndUncached(t *testing.T) {
	rec := get(t, New(testPage(t, ""), nil, nil, nil, nil), "/")
...
func TestIconIsServedAsUntrustedBytes(t *testing.T) {
	...
	rec := get(t, New(testPage(t, dir), nil, nil, nil, nil), "/icon/git")
	if rec.Code != http.StatusOK {
...
func TestIconRejectsPathTraversal(t *testing.T) {
	...
	h := New(testPage(t, iconDir), nil, nil, nil, nil)
...
func TestHealthzOK(t *testing.T) {
	rec := get(t, New(testPage(t, ""), nil, nil, nil, nil), "/healthz")
	if rec.Code != http.StatusOK {
		t.Fatalf("status %d", rec.Code)
	}
...
func TestUnknownPathIs404(t *testing.T) {
	rec := get(t, New(testPage(t, ""), nil, nil, nil, nil), "/nope")
